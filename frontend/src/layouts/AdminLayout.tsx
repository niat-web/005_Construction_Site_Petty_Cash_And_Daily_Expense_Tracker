...
const adminNavItems = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
        ...
        <path d="M5.31 11.417L3.664 12.12a1 1 0 000 1.838l7 3a1 1 0 00.788 0l7-3a1 1 0 000-1.838l-1.646-.703-5.074 2.175a1 1 0 01-.788 0l-5.634-2.415z" />
      </svg>
    ),
  },
  {
  ...
  {
    to: '/admin/cash-issuances',
    label: 'Cash Issuances',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
