...
export default function PMDashboardPage() {
  ...
  return (
    <div className="space-y-6 fade-in">
      <PageHeader title="Project Dashboard" subtitle={stats?.project_name || 'Overview of your assigned project'} />
      ...
      {loading ? <Loader /> : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {stats && (
            <BalanceCard balance={stats.balance} totalIssued={stats.issued || 0} totalSpent={stats.spent || 0} />
          )}
