...
export default function AdminReportsPage() {
  ...
  return (
    <div className="space-y-6 fade-in">
      <PageHeader title="Weekly Reports" subtitle="Analyse weekly cash flow and expenses by site" />
      ...
      <div className="card max-w-2xl">
        ...
        <form onSubmit={handleFetch} className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
          ...
          <div>
            ...
            <input type="date" className="form-input" value={params.week_start} onChange={(e) => set('week_start', e.target.value)} />
          </div>
          <div>
            <label className="form-label">Week End</label>
            <input type="date" className="form-input" value={params.week_end} onChange={(e) => set('week_end', e.target.value)} />
          </div>
